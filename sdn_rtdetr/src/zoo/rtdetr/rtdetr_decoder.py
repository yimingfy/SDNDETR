...
from .denoising import MixSamplingDenoising, MixDenoising, get_contrastive_denoising_training_group
    ...
    def forward(self, feats, targets=None):
        ...
        if self.training and self.num_denoising > 0:
            denoising_class, denoising_bbox_unact, attn_mask, dn_meta = \
                self.dn.get_sampling_cdn_group(targets,
                                               self.num_classes,
                                               self.num_queries,
